...
def main():
    ...
    _, max_item, _ = get_user_seqs(args.data_file + "/Test.txt")
    item_size = max(item_size, max_item)
    _, max_item, _ = get_user_seqs(args.data_file + "/Valid.txt")
    item_size = max(item_size, max_item)
    _, max_item, _ = get_user_seqs(args.data_file + "/Train.txt")
    item_size = max(item_size, max_item)
